...
float maxlen = 100.0;       //maxima distancia del lidar // in english max distance of the lidar
float minlen = 0.01;     //minima distancia del lidar // in english min distance of the lidar
float max_FOV = 3.0;    // en radianes angulo maximo de vista de la camara // in english maximum angle of view of the camera
float min_FOV = 0.4;    // en radianes angulo minimo de vista de la camara // in english minimum angle of view of the camera
