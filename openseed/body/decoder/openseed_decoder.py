...
class OpenSeeDDecoder(nn.Module):
    ...
    def forward(self, x, mask_features, masks, targets=None, target_queries=None, target_vlp=None, task='seg', extra={}):
        ...
        predictions_class = []
        predictions_mask = []
        if self.two_stage: # default true
            ...
            topk = self.num_queries #default 300
            ...
            if self.initialize_box_type != 'no' and do_seg: #default X
        ...
        if self.initial_pred: #default true
