...
class SwinTransformer(nn.Module):
    ...
    def __init__(
        ...
        num_features = [int(embed_dim * 2 ** i) for i in range(self.num_layers)] # embed_dim:96, num_layers:4
...
class D2SwinTransformer(SwinTransformer, Backbone):
    ...
    # "res2": ShapeSpec(channels=96, stride=4),
    # "res3": ShapeSpec(channels=192, stride=8),
