...
class LanguageEncoder(nn.Module):
    ...
    def from_config(cls, cfg):
        ...
        tokenizer_type = cfg['MODEL']['TEXT']['TOKENIZER'] #default clip
        lang_encoder = build_lang_encoder(cfg['MODEL']['TEXT'], tokenizer, cfg['VERBOSE']) #default transformer
        max_token_num = cfg['MODEL']['TEXT']['CONTEXT_LENGTH']
        
        dim_lang = cfg['MODEL']['TEXT']['WIDTH'] #512
        dim_projection = cfg['MODEL']['DIM_PROJ'] #512
